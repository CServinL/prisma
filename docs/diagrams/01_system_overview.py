...
ov.add_component("ws_endpoint",  label="WebSocket /ws",     layer="api",       group="Server",    tech="push: vault_change / hot_reload / stream_progress")
...
ov.connect("ui_watcher",   "ws_endpoint",  label="hot_reload")
...
ov.connect("chroma_svc",   "chromadb",     label="upsert")
ov.connect("zotero_svc",   "pending_q",    label="enqueue")
ov.connect("ui_static",    "ui_build",     label="serves")
ov.connect("graphify_svc", "ollama",       label="extract")
