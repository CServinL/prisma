...
m.send("zotero_svc",   "zotero_agent", label="unavailable (skip, record error)", order=17, kind="reply")
m.send("zotero_agent", "stream_mgr",   label="ok (not saved)",                 order=18, kind="reply")
