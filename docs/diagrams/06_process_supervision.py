...
tp.add_component("control_api",  label="Control API",         layer="sup",     group="Supervisor", tech="http.server — GET /status, POST /restart/{name}, POST /resources/{acquire,release} — see 07a/07b")
