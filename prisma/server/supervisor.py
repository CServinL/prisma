...
def _probe_model_vram(base_url: str, model: str, timeout: float = 300.0) -> int | None:
    ...
    .claude/qwen3-family-evaluation.md, automated. Returns None (not 0) if the
...
def _check_pool_vram_fit(
    ...
    in .claude/qwen3-family-evaluation.md's Verdict section: qwen2.5:7b-32k +
    ...
    for pool_name in affinity:
        ...
        if total > budget:
            ...
            log.warning(
                ...
                "switch between them; see .claude/qwen3-family-evaluation.md's Verdict for a real "
...
def _profile_missing_models(
    ...
    .claude/qwen3-family-evaluation.md's Verdict section) — once every
    ...
    .claude/llamacpp-vulkan-home-server-vs-desktop-client-benchmark.md in this repo for real
