...
class ZoteroConfig(BaseModel):
    ...
    library_path: str = Field(
        default_factory=lambda: str(Path.home() / "snap/zotero-snap/common/Zotero/zotero.sqlite"),
        description="Path to local Zotero database"
    )
    data_directory: str = Field(
        default_factory=lambda: str(Path.home() / "snap/zotero-snap/common/Zotero/"),
...
class LLMConfig(BaseModel):
    ...
    host: str = Field("172.29.32.1:11434", description="Host and port")
