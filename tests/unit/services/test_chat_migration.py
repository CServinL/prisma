"""Unit tests for the .md -> .sess chat migration (ADR-019)."""
import pytest
...
from prisma.storage.models.vault_models import ChatMessage, ChatRole, Footnote, FootnoteRelation, NodeType
...
def _seed_chat(vault):
    chat = vault.create_chat("Test Chat", model="qwen2.5-3b")
    vault.append_messages(chat.slug, [
        ChatMessage(role=ChatRole.user, content="hi"),
        ChatMessage(
            role=ChatRole.assistant, content="hello[^1]", model="qwen2.5-3b",
